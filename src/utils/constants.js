...
export const COUNT_CARDS_SMALL_SIZE = 5;
export const COUNT_CARDS_MEDIUM_SIZE = 8;
export const COUNT_CARDS_BIG_SIZE = 12;

export const MOVIE_DURATION_BIG = 600;
export const MOVIE_DURATION_SMALL = 40;
